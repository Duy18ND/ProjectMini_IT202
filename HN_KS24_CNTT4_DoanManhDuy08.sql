drop database if exists HN_KS24_CNTT4_DoanManhDuy;
create database HN_KS24_CNTT4_DoanManhDuy;
use HN_KS24_CNTT4_DoanManhDuy;
...
('Tran Thi Binh', '0902222222'),
('Le Van Cuong', '0903333333'),
('Pham Thi Dung', '0904444444'),
('Hoang Van Em', '0905555555');
...
price_per_day as "Giá thuê theo ngày" 
from rooms order by price_per_day;
...
select booking_id, check_in  from bookings where year(check_in) = 2024;

-- Cho biết số lượng phòng của từng loại phòng
select room_type, count(*) as "Số lượng phòng"
from rooms 
group by room_type;
